          ...
          <form onSubmit={handleSubmit} className="w-72 shrink-0 flex flex-col gap-4">
            <div className="flex-1 flex flex-col">
              ...
              <textarea
                ...
                className="flex-1 rounded-md border border-gray-200 px-3 py-2 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent resize-none"
                required
              />
              {text && (
